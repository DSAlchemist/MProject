...
// Заметка по 7 уроку!!!
//
//    Реализовать и применить все три паттерна в вашей ленте новостей.
//    Ограничить максимальный размер текста 200 точками. Если текста меньше — отобразить его целиком.
//    Добавить функциональность отображения текста целиком. Для этого добавить в ячейку текста кнопку Show more. Нажатие на неё будет изменять высоту ячейки с текстом так, чтобы текст отображался полностью.
//    Превратить кнопку Show more в Show less, нажатие на которую будет возвращать ячейке с текстом исходный вид.
